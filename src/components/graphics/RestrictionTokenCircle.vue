<template>
	...
	>
		...
		<foreignObject x="446" y="318" width="100" height="100">
			<RestrictionTokenListPopover :title="title" :target="this.id" :data="data" />
		</foreignObject>
		<circle
			fill-rule="evenodd"
			clip-rule="evenodd"
...
import RestrictionTokenListPopover from './RestrictionTokenListPopover.vue';

export default {
	extends: GraphicComponent,

	components: {
		RestrictionTokenListPopover
	},
