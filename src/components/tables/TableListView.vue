				...
				<tbody>
					...
					>
						...
						>
							...
							<TokensField v-else-if="isTokens(itemKey)" :value="item" />
							...
							<TokenFlagsField v-else-if="itemKey === 'tokenFlags'" :value="item" />
...
import TokensField from '@/components/fields/TokensField.vue';
...
import TokenFlagsField from '@/components/fields/TokenFlagsField.vue';
