/*
 *
 * (C) Copyright 2022 Bitxor Community
 *
...
<template>
	<div class="flag-container">
		<span class="flag" v-for="(value, key) in displayFlag" :key="'token_flag_' + key">
			<img
				v-if="value"
				:title="translate(key)"
				:src="iconUrl(key)"
...
import IconLimit from '../../styles/img/timelimit.png';
