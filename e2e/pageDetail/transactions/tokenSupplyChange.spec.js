...
describe('Bitxor Explorer Transaction detail page for Token Supply Change', () => {
    beforeEach(() => {
        cy.visit(`/transactions/${config.testTransactions.tokenSupplyChange}`)
    })
    ...
    describe('Transaction Detail card should', () => {
        ...
        it('render correct transaction detail titles', () => {
            const items = ['Transaction Type', 'Token ID', 'Action', 'Delta']
